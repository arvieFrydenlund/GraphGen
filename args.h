...
public:
    ...
    bool duplicate_adjacency_lists;
    ...
    BFSScratchpadArgs(const py::kwargs &kwargs,
                      ...
                      bool include_queue=false, bool reverse_adjacency_lists=false, bool duplicate_adjacency_lists=false) :
            ...
            include_queue(include_queue), reverse_adjacency_lists(reverse_adjacency_lists), duplicate_adjacency_lists(duplicate_adjacency_lists) {
        ...
        parse_and_set_arg(kwargs, "duplicate_adjacency_lists", this->duplicate_adjacency_lists, duplicate_adjacency_lists);
    }
