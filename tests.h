...
#include <iostream>
#include "instance.h"
// #include "generator.cpp"  // I don't want to make a header for generator.cpp to do this correctly


void test_khops(const int min_khops = 1, const int max_khops = 7,
...
void test_khops_gen(const int min_khops = 1, const int max_khops = 7,
    ...
    auto d = khops_gen_n(
            min_khops, max_khops,
            min_prefix_length, max_prefix_length, partition_method,
            min_vocab, max_vocab,
            batch_size,
            num_thinking_tokens,
            scratchpad_type,
...
void test_random_tree_n( // basic one
        int min_num_nodes, int max_num_nodes,
        const int max_degree, const int max_depth, const float bernoulli_p,
        const string &task_type = "shortest_path",
        const int max_path_length = 12, const int min_path_length = 3,
        const bool sort_adjacency_lists = false, const bool use_unique_depth_markers = true,
        int max_query_size = -1, const int min_query_size = 2,
